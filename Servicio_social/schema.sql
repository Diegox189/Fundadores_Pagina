...
-- days_of_week: JSON con arreglo de días ["Lun","Mar","Mie"] para flexibilidad
...
CREATE TABLE hour_logs (
  ...
  notes VARCHAR(255),
  approved TINYINT(1) DEFAULT 1, -- si se requiere flujo de aprobación, aquí se puede manejar
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO students (document, first_name, last_name, grade, email, phone)
VALUES
('10001', 'Ana', 'Pérez', '11-1', 'ana.perez@colegio.edu', '3001112233'),
('10002', 'Luis', 'Gómez', '11-2', 'luis.gomez@colegio.edu', '3002223344');

INSERT INTO teachers (name, subject, email)
VALUES
('Carolina Ruiz', 'Ciencias', 'carolina.ruiz@colegio.edu'),
('David Mora', 'Matemáticas', 'david.mora@colegio.edu');
