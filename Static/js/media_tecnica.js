...
const tecnicas = [
  {
    ...
    resumen:
      "Aprende a organizar, administrar y proteger la información con bases de datos relacionales.",
    descripcion: `
  ...
  },
  {
    ...
    resumen:
      "Diseña y conecta dispositivos inteligentes con IoT y microcontroladores.",
    ...
    carrusel: [
      { img: "../Static/img/carrusel-diseño1.jpg" },
      { img: "../Static/img/carrusel-diseño2.jpg" },
      {
  ...
  },
  {
    ...
    resumen:
      "Desarrolla tu creatividad y comunica visualmente con diseño gráfico digital.",
    descripcion: `<div class="cuadro-expandido">
...
function showDetalle(idx) {
  ...
  let contenidoHTML = "";
  if (t.nombre === "IOT") {
    // 🔥 Para IoT → primero descripción y luego carrusel con título
    contenidoHTML = `
      <div class="media-detalle">
          ...
          ${
            bannerHTML
              ? `<h3 class="titulo-carrusel">Galería de proyectos IoT</h3>${bannerHTML}`
              : ""
          }
